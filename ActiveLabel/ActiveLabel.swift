...
@IBDesignable open class ActiveLabel: UILabel {
    ...
    open var customAttributes: [NSAttributedString.Key : Any]?
    ...
    fileprivate func updateTextStorage(parseText: Bool = true, customAttributes: [NSAttributedString.Key: Any]? = nil, customRange: NSRange? = nil) {
    ...
    fileprivate func addLinkAttribute(_ mutAttrString: NSMutableAttributedString) {
        ...
        for (type, elements) in activeElements {
            ...
            case .custom:
                attributes[.font] = customFont[type] ?? font!
